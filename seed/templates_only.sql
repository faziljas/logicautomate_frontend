-- ============================================================
-- BookFlow: Templates Seed (REQUIRED for onboarding)
-- Run this in Supabase SQL Editor if onboarding fails with
-- "Key (template_id)=(salon) is not present in table templates"
-- ============================================================
