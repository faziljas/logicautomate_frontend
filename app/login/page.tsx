      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-violet-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold transition-colors"
          >
